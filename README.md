- [Recording Setup](#recording-setup)
	...
	- [Pre-requisites](#pre-requisites)
		- [Hardware](#hardware)
			- [Epihan AV.io HD video grabber](#epihan-avio-hd-video-grabber)
			- [USB Audio Capture](#usb-audio-capture)
			- [Saramonic Wireless Lavalier Microphone System](#saramonic-wireless-lavalier-microphone-system)
			...
			- [Projector](#projector)
	- [Software](#software)
		- [Open Broadcast Studio (OBS)](#open-broadcast-studio-obs)
		- [AV.io Configuration Tool](#avio-configuration-tool)
		- [Logitech Brio Configuration Tool](#logitech-brio-configuration-tool)
		- [Sound Recorded / Quicktime](#sound-recorded--quicktime)
- [Before The Day Of The Recording](#before-the-day-of-the-recording)
	- [Decisions, Decisions](#decisions-decisions)
		- [Livestreaming vs Recording](#livestreaming-vs-recording)
		- [Online vs Offline Editing](#online-vs-offline-editing)
	- [Configuring OBS](#configuring-obs)
		- [Settings](#settings)
		- [Presenter (Camera / Desktop)](#presenter-camera--desktop)
		- [Presenter (Camera Only)](#presenter-camera-only)
		- [Presenter (Desktop Only)](#presenter-desktop-only)
		- [Presenter Titles](#presenter-titles)
		- [Outro (Sponsor Thank You)](#outro-sponsor-thank-you)
- [Recording The Event](#recording-the-event)
	- [Equipment Checklist](#equipment-checklist)
	- [Connecting The Equipment](#connecting-the-equipment)
	- [Pre-Recording Checklist](#pre-recording-checklist)
- [Troubleshooting](#troubleshooting)
	- [Presenter desktop video looks "chunky" and scaled](#presenter-desktop-video-looks-chunky-and-scaled)
	- [No audio in recordings or flame chart](#no-audio-in-recordings-or-flame-chart)
